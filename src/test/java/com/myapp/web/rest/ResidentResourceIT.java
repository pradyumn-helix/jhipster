...
import com.myapp.repository.ResidentRepository;
import com.myapp.service.criteria.ResidentCriteria;
...
class ResidentResourceIT {
    ...
    @Test
    @Transactional
    void getAllResidentsByRoomidIsEqualToSomething() throws Exception {
        // Initialize the database
        residentRepository.saveAndFlush(resident);
        Room roomid;
        ...
        // Get all the residentList where roomid equals to roomidId
        defaultResidentShouldBeFound("roomidId.equals=" + roomidId);

        // Get all the residentList where roomid equals to (roomidId + 1)
        defaultResidentShouldNotBeFound("roomidId.equals=" + (roomidId + 1));
    }
