...
export class FacilityUpdateComponent implements OnInit {
  ...
  protected updateForm(facility: IFacility): void {
    ...
    this.roomsSharedCollection = this.roomService.addRoomToCollectionIfMissing(this.roomsSharedCollection, facility.roomid);
  }
  ...
  protected loadRelationshipsOptions(): void {
    this.roomService
      ...
      .pipe(map((rooms: IRoom[]) => this.roomService.addRoomToCollectionIfMissing(rooms, this.editForm.get('roomid')!.value)))
