...
/**
 * Criteria class for the {@link com.myapp.domain.Room} entity. This class is used
 * in {@link com.myapp.web.rest.RoomResource} to receive all the possible filtering options from
...
public class RoomCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, roomno, floor, type, distinct);
    }
