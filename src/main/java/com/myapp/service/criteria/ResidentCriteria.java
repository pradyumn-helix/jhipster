...
/**
 * Criteria class for the {@link com.myapp.domain.Resident} entity. This class is used
 * in {@link com.myapp.web.rest.ResidentResource} to receive all the possible filtering options from
...
public class ResidentCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, firstname, lastname, email, phonenumber, roomidId, distinct);
    }
